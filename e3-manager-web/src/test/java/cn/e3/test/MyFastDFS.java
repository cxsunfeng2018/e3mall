...
public class MyFastDFS {
	...
	public void uploadPicByFastdfs() throws Exception{
		...
		String conf = "D:\\develop\\Workspace\\e3mall\\e3mall\\e3-manager-web\\src\\main\\resources\\client.conf";
		//指定上传图片绝对地址
		String pic = "E:\\image\\a.gif";
		...
		//文件上传
		String[] urls = sc.upload_file(pic, "gif", null);
